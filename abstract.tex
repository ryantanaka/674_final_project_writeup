...
computing research. The goal here is develop a genetic algorithm for parameter
sweep, task-scheduling  problems, that uses WRENCH, a workflow management
simulation framework, as a means of individual fitness evaluations.  Using
simulation to perform fitness evaluation may lead to better task-schedules,
however at the cost of computing the actual schedule.
