...
schedules produced by the MaxMin and MinMin heuristics. Findings show that,
...
to match the performance of those heuristics as the movement through the search
space is slow, likely a result of the genotype implementation.    
